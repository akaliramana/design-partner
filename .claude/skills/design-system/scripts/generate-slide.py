...
def main():
    ...
    if args.demo:
        ...
        demo_slides = [
            ...
            {
                'type': 'testimonial',
                'quote': 'AcmeCo replaced 3 tools and 2 contractors. Our content output tripled while costs dropped 60%.',
                'author': 'Sarah Chen',
            ...
            },
            {
                ...
                'contact': 'hello@acmeco.ai',
                'website': 'acmeco.ai'
            }
        ]

        html = generate_deck(demo_slides, "AcmeCo Marketing - Pitch Deck")
